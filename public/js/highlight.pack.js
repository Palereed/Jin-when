...
function(e) {
    ...
    function f(e, t, a, i) {
        ...
        function h() {
            var e, t, r, a;
            if (!E.k) return n(k);
            for (a = "", t = 0, E.lR.lastIndex = 0, r = E.lR.exec(k); r;) a += n(k.substring(t, r.index)),
            e = l(E, r),
        ...
        function m(e, n) {
            if (k += e, null == n) return b(),
            0;
            var t = o(n, E);
            if (t) return t.skip ? k += n: (t.eB && (k += n), b(), t.rB || t.eB || (k = n)),
            v(t, n),
            t.rB ? 0 : n.length;
            var r = u(E, n);
            if (r) {
    ...
    function p(e) {
        return I.tabReplace || I.useBR ? e.replace(M,
        function(e, n) {
